...
const StudentProfile = () => {
  ...
  // Disable edit mode when switching away from Profile tab
  useEffect(() => {
    if (activeTab !== 'profile' && isEditingProfile) {
      setIsEditingProfile(false);
    }
  }, [activeTab, isEditingProfile]);
  ...
  useEffect(() => {
    if (profile) {
      ...
      setLeetcodeInput(profile.leetcode_url || '');
    }
  }, [profile]);
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const payload = {
        ...
        leetcode_url: leetcodeInput.trim(),
      };
      ...
      return (
        <div className="space-y-8">
          ...
          <div className="rounded-[2rem] bg-body/5 border border-body/10 p-6 sm:p-8 space-y-8">
            ...
            <div className="border-t border-body/10 pt-8 flex flex-col gap-6">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-body/40">Social Connections</h3>
              {isEditingProfile ? (
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-primary/20 bg-white/50 dark:bg-slate-900 px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-primary transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-wider flex items-center gap-2">
                  ...
                  {profile?.linkedin_url || profile?.github_url || profile?.leetcode_url ? (
                    <div className="flex flex-wrap gap-2">
                      {profile?.linkedin_url && (
                        <a href={profile.linkedin_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-medium hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                          LinkedIn
                        </a>
                      )}
                      {profile?.github_url && (
                        <a href={profile.github_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                      ...
                      {profile?.leetcode_url && (
                        <a href={profile.leetcode_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-xs font-medium hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors">
                          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0-.125.513 5.527 5.527 0 0 0 .062 2.362 5.83 5.83 0 0 0 .349 1.017 5.938 5.938 0 0 0 1.271 1.818l4.277 4.193.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .066-.523 2.545 2.545 0 0 1 .619-1.164L9.13 8.114c1.058-1.134 3.204-1.27 4.43-.278l3.501 2.831c.593.48 1.461.387 1.94-.207a1.384 1.384 0 0 0-.207-1.943l-3.5-2.831c-.8-.647-1.766-1.045-2.774-1.202l2.015-2.158A1.384 1.384 0 0 0 13.483 0zm-2.866 12.815a1.38 1.38 0 0 0-1.38 1.382 1.38 1.38 0 0 0 1.38 1.382H20.79a1.38 1.38 0 0 0 1.38-1.382 1.38 1.38 0 0 0-1.38-1.382z" /></svg>
                          LeetCode
                        </a>
                      )}
                    </div>
                  ) : (
                    <p className="text-xs text-muted italic">No social links added yet.</p>
                  )}
                </div>
              )}
            </div>
          ...
          {isEditingProfile && (
            <div className="flex justify-end gap-3 pt-6 border-t border-body/10">
              ...
              >
                <Card className="overflow-hidden backdrop-blur-xl shadow-2xl rounded-[1.5rem] sm:rounded-[2rem]">
                  ...
                  <div className="relative h-24 sm:h-32 bg-gradient-to-r from-primary/40 via-primary/20 to-accent/40">
                    {/* Header Buttons - Single Flex Container */}
                    <div className="absolute inset-x-0 top-3 sm:top-4 px-3 sm:px-4 z-10">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {activeTab === 'profile' ? (
                          <div>
                            <button
                              ...
                              disabled={availabilityLoading || !profile?.id}
                              className={`flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md transition-all shadow-lg text-sm font-bold ${isAvailable
                              ...
                              {availabilityLoading ? (
                                ...
                                <>
                                  <div className="relative inline-flex items-center">
                                    <div className={`w-10 h-5 rounded-full transition-colors ${isAvailable ? 'bg-white/30' : 'bg-white/20'
                                      }`}>
                                      <div className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow-md transition-transform duration-200 ${isAvailable ? 'translate-x-5' : 'translate-x-0'
                                        }`} />
                                    </div>
                                  </div>
                        ...
                        {/* Right Side - Edit Profile & Theme Buttons */}
                        <div className="flex gap-2">
                          {/* Edit Profile Button - Only on Profile Tab */}
                          {activeTab === 'profile' && (
                            <button
                              onClick={() => setIsEditingProfile(!isEditingProfile)}
                              className={`flex items-center gap-2 px-3 py-2 rounded-full backdrop-blur-md transition-all shadow-lg border text-sm font-medium ${isEditingProfile
                                ? 'bg-red-500 hover:bg-red-600 text-white border-red-600'
                                : 'bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-700 dark:text-white border-gray-200 dark:border-white/20'
                                }`}
                              aria-label={isEditingProfile ? 'Cancel Edit' : 'Edit Profile'}
                            >
                              {isEditingProfile ? (
                                <>
                          ...
                          <button
                            onClick={() => signOut()}
                            className="p-1.5 sm:p-2 rounded-full bg-red-500 hover:bg-red-600 text-white backdrop-blur-md transition-all shadow-lg border border-red-600"
                            aria-label="Logout"
                            title="Logout"
                          >
                            <PowerIcon className="w-4 sm:w-5 h-4 sm:h-5" />
                          </button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative px-4 pb-6 sm:px-6 sm:pb-8">
                    ...
                    <div className="mt-6 px-4 sm:px-6">
                      <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-3">Connect</h3>
                      <div className="flex flex-wrap gap-2">
                        {profile?.linkedin_url && (
                          <a
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-medium hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                          >
                        ...
                        {profile?.leetcode_url && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-xs font-medium hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors"
                          >
                            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                              <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0-.125.513 5.527 5.527 0 0 0 .062 2.362 5.83 5.83 0 0 0 .349 1.017 5.938 5.938 0 0 0 1.271 1.818l4.277 4.193.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .066-.523 2.545 2.545 0 0 1 .619-1.164L9.13 8.114c1.058-1.134 3.204-1.27 4.43-.278l3.501 2.831c.593.48 1.461.387 1.94-.207a1.384 1.384 0 0 0-.207-1.943l-3.5-2.831c-.8-.647-1.766-1.045-2.774-1.202l2.015-2.158A1.384 1.384 0 0 0 13.483 0zm-2.866 12.815a1.38 1.38 0 0 0-1.38 1.382 1.38 1.38 0 0 0 1.38 1.382H20.79a1.38 1.38 0 0 0 1.38-1.382 1.38 1.38 0 0 0-1.38-1.382z" />
                            </svg>
                        ...
                        {!profile?.linkedin_url && !profile?.github_url && !profile?.leetcode_url && (
                          <p className="text-xs text-gray-500 dark:text-gray-400 italic">No social links added yet</p>
                        )}
                      </div>
                    </div>
