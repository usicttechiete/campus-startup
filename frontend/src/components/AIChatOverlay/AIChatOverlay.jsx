...
const AIChatOverlay = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pb-20">
            ...
            {/* Chat Box */}
            <div
                className="relative w-full max-w-[460px] h-[65vh] bg-white rounded-3xl shadow-2xl flex flex-col animate-slide-up overflow-hidden"
                ...
                <div className="p-4 border-t border-gray-100 bg-white">
                    <form onSubmit={handleSend} className="flex items-center gap-2">
                        <input
                            ...
                            className="flex-1 bg-gray-100 rounded-full px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition outline-none"
                            disabled={isLoading}
                        />
                        <button
                            type="submit"
